...
class TimeTableViewController: UIViewController {
    ...
    var timeTableTableView: UITableView = {
        ...
        table.register(EmptyDataCellView.self, forCellReuseIdentifier: EmptyDataCellView.identifier)
...
extension TimeTableViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case nil:
            if let cell = tableView.dequeueReusableCell(withIdentifier: EmptyDataCellView.identifier,
                                                        for: indexPath) as? EmptyDataCellView {
        ...
        default:
            guard let cell = tableView.dequeueReusableCell(withIdentifier: LessonCellView.identifier,
                                                           for: indexPath) as? LessonCellView else {
            ...
            cell.lessonType.text = getLessonType(abbr: timeTable?
    ...
    -> UISwipeActionsConfiguration? {
        let action = UIContextualAction(style: .normal, title: "Раскрыть") { [weak self] (_, _, completionHandler) in
            ...
            if self?.timeTable == nil || self?.timeTable?.days.count == 0 {
                ...
                modalView.lessonType.text =  self?.getLessonType(abbr: self?.timeTable?.days[indexPath.section]
                ...
                modalView.groups.text = self?.timeTable?.days[indexPath.section]
